...
import PriceTicker from './Base/PriceTicker';
            ...
            <div className="navbar-container">
                <div className="navbar">
                    ...
                    <div className="profile-container">
                        ...
                        <Dropdown hidden={this.state.dropdownHidden} user={this.props.user} list={this.props.listMd} profile={this.props.profileMd} logout={this.logout} />
                    </div>
                </div>
            </div>
        );
