            ...
            <div className="navbar-container">
                <div className="navbar">
                    ...
                    <div className="profile-container">
                        <button name="login" onClick={this.props.loginMd} className="btn btn-login">Login</button>
                        <button name="register" onClick={this.props.regMd} className="btn btn-login">Register</button>
                        ...
                        <Dropdown hidden={this.state.dropdownHidden} username={this.props.username} list={this.props.listMd} profile={this.props.profileMd} logout={this.props.logout} />
                    </div>
                </div>
            </div>
        );
